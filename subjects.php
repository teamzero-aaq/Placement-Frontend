...
<head>
  ...
  <title>Placement Assistant | Subjects </title>
    ...
    <div class="container h-100">
      <div class="row h-100 align-items-center justify-content-center text-center">
        <div class="col-lg-10 align-self-end">
          <h1 class="text-uppercase text-white font-weight-bold">Subject</h1>
        </div>
                          ...
                          <h2><?php echo $row['subject'];?></h2>                       
                            ...
                            <div class="col text-center"> 
                             ...
                             <input type="hidden" name="tempdept" value="<?php echo $row['dept_id'];?>">
                              <a href="test.html"> <button type="button" class="btn btn-info btn-sm align-item-center" name="subjectbtn">
