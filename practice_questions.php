...
<body>
  ...
  <div class="container testsection">
    <div class="row">
     ...
     <?php
    if(isset($_POST['take_practice'])){
      
    
error_reporting(0);

#$data = file_get_contents('Applications\\MAMP\\htdocs\\placement\\indiabix\\Scrape_IndiaBix_QA-master'.$_POST['take_practice'].'.json');
$data = file_get_contents('.\\indiabix\\Scrape_IndiaBix_QA-master'.$_POST['take_practice'].'.json');
$json = json_decode($data,true);


echo $_POST['take_practice'];
