...
<head>
  ...
  <title>Placement Assistant | GD Page </title>
...
<body>
 ...
 <?php if(isset($_POST['view_gd'])){
        $mysqli = new mysqli("localhost", "root", "root", "placement");
    
$result1 = $mysqli->query('select * from gd_hr where id='.$_POST['view_gd'].'');
    ...
    <div class="container h-100">
      <div class="row h-100 align-items-center justify-content-center text-center">
        <div class="col-lg-10 align-self-end">
          <h3 class="text-uppercase text-white font-weight-bold"><?php echo $row['question']; ?></h3>
        </div>
...
$result = $mysqli->query('select * from forum where id='.$_POST['view_gd'].'');
}
		...
		<div>
			...
			<form action="verify_user.php" method="POST" id="user_thoughts">
			 ...
			 <div class="form-group">
			  ...
			  <button type="submit" value="<?php echo $_POST['view_gd'] ?>" form="user_thoughts" name="user_response" class="btn btn-info">Submit</button>
			</form>
